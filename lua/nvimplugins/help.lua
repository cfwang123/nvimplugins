...
local function catalog()
  return {
    ...
    },
    {
      ...
      title_zh = "表格模式",
      title_en = "Table mode",
      desc_zh = "即时对齐 Markdown 表格（仿 table-mode）；开启时 Unicode 框线预览",
      desc_en = "Live Markdown table align; Unicode box preview while on",
      commands = {
      ...
      keys = {
        ...
        { default = "preview_style", desc_zh = "unicode 框线 / 退出还原 GFM", desc_en = "unicode boxes / restore GFM on exit" },
        ...
        { default = "gy (visual)", desc_zh = "复制为 TSV（去 |）", desc_en = "Yank as TSV (strip |)" },
    ...
    },
    {
      ...
      title_zh = "收藏夹",
      title_en = "Bookmarks",
      desc_zh = "文件/文件夹收藏，右侧列表快速打开",
      desc_en = "File/folder bookmarks sidebar",
      commands = {
        { cmd = "BookmarksOpen", desc_zh = "打开收藏夹", desc_en = "Open sidebar" },
        { cmd = "BookmarksToggle", desc_zh = "开关收藏夹", desc_en = "Toggle sidebar" },
        { cmd = "BookmarksClose", desc_zh = "关闭", desc_en = "Close" },
        { cmd = "BookmarksAddFile", desc_zh = "收藏当前文件", desc_en = "Add current file" },
        { cmd = "BookmarksAddDir", desc_zh = "收藏当前目录", desc_en = "Add current directory" },
        { cmd = "BookmarksRefresh", desc_zh = "重新加载", desc_en = "Reload" },
      },
      keys = {
        { field = "keys_open", default = "<leader>bo", desc_zh = "打开收藏夹", desc_en = "Open bookmarks" },
        { field = "keys_add_file", default = "A", desc_zh = "添加当前文件", desc_en = "Add current file" },
        { field = "keys_add_dir", default = "D", desc_zh = "添加当前目录", desc_en = "Add current directory" },
        { default = "o / t / S / dd", desc_zh = "窗口内：打开 / 新标签 / 短名 / 删除", desc_en = "In window: open / tab / short / delete" },
      },
    },
    {
      plugin = "nvimplugins",
