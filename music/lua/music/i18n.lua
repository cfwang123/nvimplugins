...
local STR = {
  zh = {
    ...
    presets = "预设",
    presets_title = "选择内置 MIDI（Enter/点击 · q 取消）",
    midi_loaded = "music: 已加载 ",
    midi_need_win = "music: MIDI 播放需要 Windows + winmm.dll",
    midi_script_missing = "music: 缺少 MIDI 脚本 ",
    midi_daemon_fail = "music: 无法启动 MIDI 引擎 (需 Windows + winmm.dll)",
    py_missing = "music: 未找到 python",
    midi_badge = "MIDI",
    loading = "加载中…",
  },
  en = {
    ...
    lang_to_zh = "music: UI → 中文",
    presets = "Presets",
    presets_title = "Pick built-in MIDI (Enter/click · q cancel)",
    midi_loaded = "music: loaded ",
    midi_need_win = "music: MIDI needs Windows + winmm.dll",
    midi_script_missing = "music: missing MIDI script ",
    midi_daemon_fail = "music: cannot start MIDI engine (need Windows + winmm.dll)",
    py_missing = "music: python not found",
    midi_badge = "MIDI",
    loading = "Loading…",
  },
}
